...
TEST_F(CPULoadTest, lda_zero_page) {
  bus.cpu_write(0x42, 0x37);
  bus.cpu_write(0xFFFC, (nes::u8)(nes::Opcode::LDA_ZPG));
  bus.cpu_write(0xFFFD, 0x42);
...
TEST_F(CPULoadTest, ldx_zero_page) {
  bus.cpu_write(0x42, 0x37);
  bus.cpu_write(0xFFFC, (nes::u8)(nes::Opcode::LDX_ZPG));
  bus.cpu_write(0xFFFD, 0x42);
...
TEST_F(CPULoadTest, ldy_zero_page) {
  bus.cpu_write(0x42, 0x37);
  bus.cpu_write(0xFFFC, (nes::u8)(nes::Opcode::LDY_ZPG));
  bus.cpu_write(0xFFFD, 0x42);
...
TEST_F(CPULoadTest, ldy_zero_page_x) {
  ...
  bus.cpu_write(0x44, 0x37);  // Target address: 0x42 + 0x02 = 0x44
  bus.cpu_write(0xFFFE, (nes::u8)(nes::Opcode::LDY_ZPX));
...
TEST_F(CPULoadTest, ldy_absolute) {
  bus.cpu_write(0x0242, 0x37);
  bus.cpu_write(0xFFFC, (nes::u8)(nes::Opcode::LDY_ABS));
  bus.cpu_write(0xFFFD, 0x42);
  bus.cpu_write(0xFFFE, 0x02);
...
TEST_F(CPULoadTest, ldy_absolute_x) {
  ...
  bus.cpu_write(0x0244, 0x37);
  bus.cpu_write(0xFFFE, (nes::u8)(nes::Opcode::LDY_ABX));
  bus.cpu_write(0xFFFF, 0x42);
  bus.cpu_write(0x0000, 0x02);
...
TEST_F(CPULoadTest, ldy_absolute_x_page_cross) {
  // First set X register
  bus.cpu_write(0xFFFC, (nes::u8)(nes::Opcode::LDX_IMM));
  bus.cpu_write(0xFFFD, 0xFF);  // X = 0xFF to force page cross
  execute_cycles(2);            // LDX_IMM takes 2 cycles

  // Then test LDY absolute X with page cross
  bus.cpu_write(0x0341, 0x37);
  bus.cpu_write(0xFFFE, (nes::u8)(nes::Opcode::LDY_ABX));
  bus.cpu_write(0xFFFF, 0x42);
  bus.cpu_write(0x0000, 0x02);
