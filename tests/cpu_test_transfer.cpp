...
TEST_F(CPUTransferTest, tax) {
  ...
  bus.cpu_write(0xFFFE, (nes::u8)(nes::Opcode::TAX_IMP));
...
TEST_F(CPUTransferTest, tay) {
  ...
  bus.cpu_write(0xFFFE, (nes::u8)(nes::Opcode::TAY_IMP));
  execute_cycles(2);  // TAX takes 2 cycles
...
TEST_F(CPUTransferTest, txa) {
  ...
  bus.cpu_write(0x0001, (nes::u8)(nes::Opcode::TXA_IMP));
...
TEST_F(CPUTransferTest, tsx) {
  ...
  // Execute TSX_IMP
  bus.cpu_write(0xFFFC, (nes::u8)nes::Opcode::TSX_IMP);
...
TEST_F(CPUTransferTest, txa_zero_value) {
  ...
  bus.cpu_write(0xFFFE, (nes::u8)nes::Opcode::TXA_IMP);
  execute_cycles(2);
...
TEST_F(CPUTransferTest, txa_negative_value) {
  ...
  bus.cpu_write(0xFFFC, (nes::u8)nes::Opcode::LDX_IMM);
  bus.cpu_write(0xFFFD, 0x80);  // Negative value (bit 7 set)
  execute_cycles(2);
...
TEST_F(CPUTransferTest, txs) {
  ...
  bus.cpu_write(0xFFFE, (nes::u8)nes::Opcode::TXS_IMP);
...
TEST_F(CPUTransferTest, tya) {
  ...
  bus.cpu_write(0xFFFE, (nes::u8)nes::Opcode::TYA_IMP);
