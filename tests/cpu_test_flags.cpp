...
TEST_F(CPUFlagTest, clc_clears_carry_flag) {
  ...
  bus.cpu_write(0xFFFD, (nes::u8)nes::Opcode::CLC_IMP);
...
TEST_F(CPUFlagTest, clc_leaves_other_flags_unchanged) {
  ...
  bus.cpu_write(0xFFFE, 0x80);  // Load 0x80 into A to set negative flag
  execute_cycles(2);
  ...
  // Execute CLC_IMP instruction
  bus.cpu_write(0xFFFF, (nes::u8)nes::Opcode::CLC_IMP);
  execute_cycles(2);
...
TEST_F(CPUFlagTest, sec_sets_carry_flag) {
  ...
  bus.cpu_write(0xFFFD, (nes::u8)nes::Opcode::SEC_IMP);
...
TEST_F(CPUFlagTest, sec_leaves_other_flags_unchanged) {
  // Set up initial flags
  bus.cpu_write(0xFFFC, (nes::u8)nes::Opcode::CLC_IMP);  // Clear carry flag
  execute_cycles(2);
  ...
  // Execute SEC_IMP instruction
  bus.cpu_write(0xFFFF, (nes::u8)nes::Opcode::SEC_IMP);
  execute_cycles(2);
...
TEST_F(CPUFlagTest, clc_sec_pc_advancement) {
  ...
  // Execute CLC_IMP
  bus.cpu_write(initial_pc, (nes::u8)nes::Opcode::CLC_IMP);
  execute_cycles(2);
  ...
  bus.cpu_write(sec_pc, (nes::u8)nes::Opcode::SEC_IMP);
  execute_cycles(2);
...
TEST_F(CPUFlagTest, cli_clears_interrupt_flag) {
  ...
  bus.cpu_write(0xFFFC, (nes::u8)nes::Opcode::SEI_IMP);
  execute_cycles(2);
  ...
  bus.cpu_write(0xFFFD, (nes::u8)nes::Opcode::CLI_IMP);
...
TEST_F(CPUFlagTest, cli_leaves_other_flags_unchanged) {
  // Set up initial flags
  bus.cpu_write(0xFFFC, (nes::u8)nes::Opcode::SEI_IMP);  // Set interrupt flag
  execute_cycles(2);
  ...
  bus.cpu_write(0xFFFF, 0x80);  // Load 0x80 into A to set negative flag
  execute_cycles(2);
  ...
  // Execute CLI instruction
  bus.cpu_write(0x0000, (nes::u8)nes::Opcode::CLI_IMP);
  execute_cycles(2);
...
TEST_F(CPUFlagTest, cld_clears_decimal_flag) {
  ...
  bus.cpu_write(0xFFFC, (nes::u8)nes::Opcode::SED_IMP);
  execute_cycles(2);
  ...
  bus.cpu_write(0xFFFD, (nes::u8)nes::Opcode::CLD_IMP);
...
TEST_F(CPUFlagTest, cld_leaves_other_flags_unchanged) {
  // Set up initial flags
  bus.cpu_write(0xFFFC, (nes::u8)nes::Opcode::SED_IMP);  // Set decimal flag
  execute_cycles(2);
  ...
  // Execute CLD instruction
  bus.cpu_write(0x0000, (nes::u8)nes::Opcode::CLD_IMP);
  execute_cycles(2);
...
TEST_F(CPUFlagTest, clv_clears_overflow_flag) {
  ...
  bus.cpu_write(0xFFFC, (nes::u8)nes::Opcode::CLC_IMP);  // Clear carry first
  execute_cycles(2);

  bus.cpu_write(0xFFFD, (nes::u8)nes::Opcode::LDA_IMM);
  bus.cpu_write(0xFFFE, 0x50);  // Load 0x50 (+80) into A
  execute_cycles(2);

  bus.cpu_write(0xFFFF, (nes::u8)nes::Opcode::ADC_IMM);
  bus.cpu_write(0x0000, 0x50);  // Add 0x50 (+80) to A, causing overflow (result is 0xA0)
  execute_cycles(2);
  ...
  bus.cpu_write(0x0001, (nes::u8)nes::Opcode::CLV_IMP);
...
TEST_F(CPUFlagTest, clv_leaves_other_flags_unchanged) {
  ...
  bus.cpu_write(0xFFFF, (nes::u8)nes::Opcode::ADC_IMM);
  bus.cpu_write(0x0000, 0x50);  // Add 0x50 (+80) to A, causing overflow
  execute_cycles(2);

  // Also set carry flag
  bus.cpu_write(0x0001, (nes::u8)nes::Opcode::SEC_IMP);
  execute_cycles(2);
  ...
  // Execute CLV instruction
  bus.cpu_write(0x0002, (nes::u8)nes::Opcode::CLV_IMP);
  execute_cycles(2);
...
TEST_F(CPUFlagTest, flag_clear_sequence) {
  ...
  bus.cpu_write(pc++, (nes::u8)nes::Opcode::SEC_IMP);  // Set carry
  bus.cpu_write(pc++, (nes::u8)nes::Opcode::SEI_IMP);  // Set interrupt disable
  bus.cpu_write(pc++, (nes::u8)nes::Opcode::SED_IMP);  // Set decimal
  ...
  bus.cpu_write(pc++, (nes::u8)nes::Opcode::CLC_IMP);
  bus.cpu_write(pc++, (nes::u8)nes::Opcode::CLI_IMP);
  bus.cpu_write(pc++, (nes::u8)nes::Opcode::CLD_IMP);
